...
function submitForm() {
  ...
  if ($("#input-category").val() === "beginner") {
    db.collection("Beginner Members")
      .doc(inputEmail)
      .set({
        Email: inputEmail,
        Name: inputName,
  ...
  if ($("#input-category").val() === "intermediate") {
    db.collection("Intermediate Members")
      .doc(inputEmail)
      .set({
        Email: inputEmail,
        Name: inputName,
  ...
  if ($("#input-stack").val() === "web-frontend") {
    db.collection("Frontend Members")
      .doc(inputEmail)
      .set({
        Email: inputEmail,
        Name: inputName,
  ...
  if ($("#input-stack").val() === "digital-marketing") {
    db.collection("digital-marketing")
      .doc(inputEmail)
      .set({
        Email: inputEmail,
        Name: inputName,
  ...
  if ($("#input-stack").val() === "digital-design") {
    db.collection("Digital Design Members")
      .doc(inputEmail)
      .set({
        Email: inputEmail,
        Name: inputName,
  ...
  if ($("#input-stack").val() === "leadership-skills") {
    db.collection("Leadership Members")
      .doc(inputEmail)
      .set({
        Email: inputEmail,
        Name: inputName,
  ...
  db.collection("Members")
    ...
    .then(function() {
      ...
      alert(
        "welcome to DSC Unilag " +
          inputName +
          ". Your membership has been registered to learn " +
          inputStack
      );
    })
